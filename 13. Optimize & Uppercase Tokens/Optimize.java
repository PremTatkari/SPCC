...
public class Optimize {
    ...
    List<String> result = new ArrayList<String>(Arrays.asList("a", "c", "b", "d", "e"));
    ...
    public void getStatements() {
        ...
        this.statements.put("c", "a");
        this.statements.put("b", "a+c");

        this.statements.put("d", "4*b");
        this.statements.put("e", "4*b+100");
    }
